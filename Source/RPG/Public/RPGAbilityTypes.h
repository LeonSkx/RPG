...
USTRUCT(BlueprintType)
struct FRPGDamageEffectParams
{
    GENERATED_BODY()

    FRPGDamageEffectParams(){}
...
// Struct para compatibilidade com outros arquivos
USTRUCT(BlueprintType)
struct FDamageEffectParams : public FRPGDamageEffectParams
{
    GENERATED_BODY()

    FDamageEffectParams() : FRPGDamageEffectParams() {}
};

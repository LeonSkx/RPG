...
/**
 * Animation Instance for RPG characters
 * Handles movement, aiming, and GAS integration for animations
 */
UCLASS()
...
public:	
	...
	/** Register for aim tag changes (optional - call this if you have an aim tag) */
	UFUNCTION(BlueprintCallable, Category = "Animation")
	void RegisterAimTag(const FGameplayTag& AimTag);
...
private:
	...
	// Optional: Tag to track aiming state
	FGameplayTag AimTag;

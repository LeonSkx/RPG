...
void ARPGEffectActor::Tick(float DeltaTime)
{
	...
	if (bRotates || bSinusoidalMovement)
	{
...
void ARPGEffectActor::OnOverlap(AActor* TargetActor)
{
	...
	if (ActorsOnOverlap.Contains(TargetActor)) return;
	ActorsOnOverlap.Add(TargetActor);
...
void ARPGEffectActor::OnEndOverlap(AActor* TargetActor)
{
	...
	ActorsOnOverlap.Remove(TargetActor);
	...
	if (InfiniteEffectRemovalPolicy == EEffectRemovalPolicy::RemoveOnEndOverlap)
	{
		...
		{
			if (Pair.Value == TargetASC && TargetASC->RemoveActiveGameplayEffect(Pair.Key, 1))
			{
